...
if __name__ == "__main__":
    ...
    finding = 1
    # Read scan
    [scan,spacing,origin,transfmat] =  readMhd('E:/Stuff/FEUP/VCOM/LNDb_dataset/data/LNDb-{:04}.mhd'.format(lnd))
    print(spacing,origin,transfmat)
    # Read segmentation mask
    [mask,spacing,origin,transfmat] =  readMhd('E:/Stuff/FEUP/VCOM/LNDb_dataset/masks/LNDb-{:04}_rad{}.mhd'.format(lnd,rad))
    print(spacing,origin,transfmat)
    # Read nodules csv
    csvlines = readCsv('E:/Stuff/FEUP/VCOM/LNDb_dataset/trainset_csv/trainNodules.csv')
    header = csvlines[0]
    nodules = csvlines[1:]
    for n in nodules:
